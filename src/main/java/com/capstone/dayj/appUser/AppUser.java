...
public class AppUser extends BaseEntity {
    ...
    @Builder
    public AppUser(int id, String name, String nickname, String password, String email, String role, String provider, String providerId, String profilePhoto, Boolean isAlarm, List<GroupMember> groupMembers, List<Plan> plans, List<Post> posts, List<Comment> comments, List<Statistics> statistics) {
        this.id = id;
        this.name = name;
