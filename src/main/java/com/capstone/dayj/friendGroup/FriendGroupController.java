...
public class FriendGroupController {
    ...
    public FriendGroupDto.Response readFriendGroupById(@PathVariable int app_user_id, @PathVariable int group_id) {
        return friendGroupService.readFriendGroupById(app_user_id, group_id);
    }

    @PatchMapping("/{group_id}")
    public FriendGroupDto.Response patchFriendGroup(@PathVariable int app_user_id, @PathVariable int group_id, @Valid @RequestBody FriendGroupDto.Request dto) {
        return friendGroupService.updateFriendGroup(app_user_id, group_id, dto);
    }
